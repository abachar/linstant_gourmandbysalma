...
export const PurchaseListPage: Component<{ purchases: GetPurchasesReturn}> = ({purchases}) => {
	return (
    <PageLayout title="Achats" action={<HeaderAddButton to="/purchases/new" />}>
      <h3 class="text-white/60 text-sm font-bold uppercase tracking-widest px-1 py-2">
        Liste des achats
      </h3>
