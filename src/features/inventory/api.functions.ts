...
import { createInventoryItem, getInventory, getInventoryById, updateInventoryItem } from "./api.server";

export const getInventoryFn = createServerFn({ method: "GET" }).handler(getInventory);
